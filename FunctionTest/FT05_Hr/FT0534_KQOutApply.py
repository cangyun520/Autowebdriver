...
class OutApply(unittest.TestCase):
    def setUp(self):
        ...
        driver.switch_to.frame("frame_tab_PM000953")

    """人事管理-考勤管理-外出申请添加"""
    def test_0534_01(self):
        """人事管理-考勤管理-外出申请添加功能"""
        driver = self.driver
        ...
        time.sleep(1)
        # 起止时间
        driver.find_element_by_id("StartTime_H").click()
        time.sleep(1)
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/hr/test_0534_01.jpg")
                print("Error：" + i.text)
                unittest.expectedFailure("test_0534_01")
