    ...
    def test_1202_01_sqlNull(self):
        ...
        for i in v_tip:
            if "SQL语句为空" in i.text:
                ...
                print(i.text)
                unittest.expectedFailure("test_1202_01_sqlNull")

    # 系统管理-报表设置-数据为空导出
    def test_1202_02_exportNull(self):
        """系统管理-报表设置-数据为空导出"""
        driver = self.driver
        ...
        for i in v_tip:
            if "没有导出数据" in i.text:
                ...
                print(i.text)
                unittest.expectedFailure("test_1202_02_exportNull")

    """费用管理-费用申请-添加界面关闭功能"""
    def test_1202_03_add(self):
        driver = self.driver
        # 选择SBO数据库
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/test_1202_01_add.jpg")
                print(i.text)
