    ...
    def test_0904_01_add(self):
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/oa/test_0904_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0904_01_add")

    """费用管理-报销管理-费用报销界面关闭功能"""
    def test_0904_02(self):
        """费用管理-报销管理-费用报销界面关闭功能"""
        driver = self.driver
        # 随机双击行数据进入到查看界面
        ...
        try:
            ...
            unittest.expectedFailure("test_0904_02")
