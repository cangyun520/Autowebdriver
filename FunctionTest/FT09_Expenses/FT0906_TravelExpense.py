...
class Reimbursement(unittest.TestCase):
    ...
    def test_0906_01_add(self):
        ...
        time.sleep(1)
        ClasForm.form_today(self, "DateField4")
        # 出发地点
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/oa/test_0906_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0906_01_add")

    """费用管理-报销管理-差旅费报销界面关闭功能"""
    def test_0906_02(self):
        """费用管理-报销管理-差旅费报销界面关闭功能"""
        driver = self.driver
        ...
        try:
            ...
            unittest.expectedFailure("test_0906_02")
