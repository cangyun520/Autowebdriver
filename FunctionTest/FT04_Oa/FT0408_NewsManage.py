    ...
    def test_0408_01_Add(self):
        ...
        for i in msg:
            if "添加成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/oa/test_0408_01_Add.jpg")
                print(i.text)
                unittest.expectedFailure("test_050502_01_Add")

    """行政办公-通知公告-新闻公告添加界面必填项校验"""
    def test_0408_02(self):
        """行政办公-通知公告-新闻公告添加界面必填项校验"""
        driver = self.driver
        driver.find_element_by_xpath("//*[@id='form_wizard_1']/div[2]/div[1]/div/div[2]/a").click()
        time.sleep(3)
        ...
        for i in v_tip:
            try:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/oa/test_0408_02.jpg")
                unittest.expectedFailure("test_0408_02")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(NewsManage("test_0408_01_Add"))
    # 执行测试集合
