...
class NewLook(unittest.TestCase):
    ...
    def test_0410_01_Look(self):
        ...
        if v_check.is_displayed():
            ...
            driver.get_screenshot_as_file(root_path() + "TestPicture/oa/test_0410_01_Look.jpg")
            unittest.expectedFailure("test_0410_01_Look")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(NewLook("test_0410_01_Look"))
    # 执行测试集合
