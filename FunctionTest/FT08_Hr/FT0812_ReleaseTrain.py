    ...
    def test_0812_01(self):
        ...
        for i in v_tip:
            if "发布成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + 'TestPicture/hr/test_0812_01.jpg')
                print("Error：" + i.text)
                unittest.expectedFailure("test_0812_01")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(ReleaseTrain("test_0812_01"))
    # 执行测试集合
