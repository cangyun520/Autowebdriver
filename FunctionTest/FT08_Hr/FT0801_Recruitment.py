    ...
    def test_0801_01(self):
        ...
        for i in v_tip:
            if "保存单据成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + 'TestPicture/oa/test_0801_01.jpg')
                print("Error：" + i.text)
                unittest.expectedFailure("test_0801_01")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(Recruitment("test_0801_01"))
    # 执行测试集合
