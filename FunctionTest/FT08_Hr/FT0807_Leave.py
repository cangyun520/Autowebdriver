    ...
    def test_0807_01(self):
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/hr/test_0807_01.jpg")
                print("Error：" + i.text)
                unittest.expectedFailure("test_0807_01")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(Leave.py("test_0807_01_add"))
    # 执行测试集合
