...
class Transfer(unittest.TestCase):
    ...
    def test_0806_01(self):
        ...
        # 原因
        driver.find_element_by_id("txtTransferReason").send_keys(fun_data_character(400, 800))
        # 自由流审批人选择
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                unittest.expectedFailure("test_0806_01")
                driver.get_screenshot_as_file(root_path() + "TestPicture/hr/test_0806_01.jpg")
                print("Error：" + i.text)
...
if __name__ == "__main__":
    ...
    testsuit.addTest(Transfer.py("test_0806_01_add"))
    # 执行测试集合
