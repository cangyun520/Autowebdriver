    ...
    def test_0710_01_Add(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0710_01_Add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0710_01_Add")

    # 客商管理-供应商主数据-更新功能
    def test_0710_02(self):
        """客商管理-供应商主数据-更新功能"""
        driver = self.driver
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0710_02.jpg")
                print("Error：" + i.text)
                unittest.expectedFailure("test_0710_02")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(SuppliersMaster("test_0710_01_Add"))
