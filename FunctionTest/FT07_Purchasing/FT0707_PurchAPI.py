    ...
    def test_0707_01(self):
        ...
        for i in v_tip:
            if "成功，单号" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0707_01.jpg")
                print(i.text)
                unittest.expectedFailure("test_0707_01")

    # 采购管理-应付发票-业务伙伴编号为空穿透提示检查
    def test_0707_02(self):
        """采购管理-应付发票-业务伙伴编号为空穿透提示检查"""
        driver = self.driver
        ...
        for i in v_tip:
            if "业务伙伴为空" in i.text:
                ...
                unittest.expectedFailure("test_0707_02")

    # 采购管理-应付发票-业务伙伴主数据穿透功能检查
    def test_0707_03_First(self):
        """采购管理-应付发票-业务伙伴主数据穿透功能检查"""
        driver = self.driver
        ...
        try:
            ...
            unittest.expectedFailure("test_0707_03_First")

    # 采购管理-应付发票-单据复制到功能
    def test_0707_04_goto(self):
        """采购管理-应付发票-单据复制到功能"""
        driver = self.driver
        ...
        try:
            ...
            for i in v_tip:
                if "成功" in i.text:
                    ...
                    driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0707_04_goto.jpg")
                    print(i.text)
                    unittest.expectedFailure("test_0707_04_goto")
        except ImportError:
    ...
    def test_0707_06_copy(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                print(i.text)
                unittest.expectedFailure("test_0707_06_copy")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(PurchAPI("test_050404_01_Add"))
