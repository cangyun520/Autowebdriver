    ...
    def test_0605_01_add(self):
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/test_0605_01_add.jpg")
                print(i.text)
    ...
    def test_0605_03_draft(self):
        ...
        for i in v_tip:
            if "保存草稿成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/test_0605_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0605_03_draft")

    """费用管理-付款申请-普通款项申请添加功能"""
    def test_0605_04_addNormal(self):
        """费用管理-付款申请-普通款项申请添加功能"""
        driver = self.driver
        driver.find_element_by_id("BtnAdd").click()
        time.sleep(3)
        ...
        for i in v_tip:
            if "流程已触发" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/test_0605_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0605_01_addNormal")
