    ...
    def test_0610_01_add(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0610_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0610_01_add")

    # 销售退货-业务伙伴编号为空穿透提示检查
    def test_0610_02_client(self):
        """销售退货-业务伙伴编号为空穿透提示检查"""
        driver = self.driver
        ...
        for i in v_tip:
            if "业务伙伴为空" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0610_02_client.jpg")
                print(i.text)
                unittest.expectedFailure("test_0610_02_client")

    # 销售退货-伙伴主数据穿透功能
    def test_0610_03_First(self):
        """销售退货-业务伙伴主数据穿透功能"""
        driver = self.driver
        ...
        try:
            ...
            driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0610_03_First.jpg")
            unittest.expectedFailure("test_0610_03_First")

    # 销售退货-单据复制到功能
    def test_0610_04_goto(self):
        """销售退货-单据复制到功能"""
        driver = self.driver
        ...
        try:
            ...
            for i in v_tip:
                if "成功，单号" in i.text:
                    ...
                    driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0610_04_goto.jpg")
                    print(i.text)
                    unittest.expectedFailure("test_0610_04_goto")
        except ImportError:
            print("销售退货-单据已清，无复制到选项")

    # 销售管理-销售退货-目标凭证查看
    def test_0610_05_target(self):
        """销售管理-销售退货-目标凭证查看"""
        driver = self.driver
        driver.find_element_by_id("btnLast").click()
        time.sleep(4)
    ...
    def test_0610_06_copy(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                print(i.text)
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0610_06_copy.jpg")
                unittest.expectedFailure("test_0610_06_copy")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(SaleReturn("test_0610_01_add"))
