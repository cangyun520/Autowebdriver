    ...
    def test_0606_01_Add(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0606_01_Add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0606_01_Add")

    # 销售管理-应收贷项凭证-客户编号为空穿透提示检查
    def test_0606_02_Client(self):
        """销售管理-应收贷项凭证-客户编号为空穿透提示检查"""
        driver = self.driver
        ...
        for i in v_tip:
            if "业务伙伴为空" in i.text:
                ...
                print(i.text)
                unittest.expectedFailure("test_0606_02_Client")

    # 销售管理-应收贷项凭证-客户主数据穿透功能
    def test_0606_03_First(self):
        """销售管理-应收贷项凭证-客户主数据穿透功能"""
        driver = self.driver
        ...
        try:
            ...
            unittest.expectedFailure("test_0606_03_First")

    # 销售管理-应收贷项凭证-目标凭证查看
    def test_0606_05_target(self):
        """销售管理-应收发票-目标凭证查看"""
        driver = self.driver
    ...
    def test_0606_06_copy(self):
        ...
        for i in v_tip:
            if "成功，单号" in i.text:
                ...
                print(i.text)
                unittest.expectedFailure("test_0606_06_copy")
...
if __name__ == "__main__":
    ...
    testsuit.addTest(SalesCredit("test_0606_01_Add"))
