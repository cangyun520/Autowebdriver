    ...
    def test_0504_01_Add(self):
        ...
        for i in v_tip:
            if "单据添加成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0504_01_Add.jpg")
                print(i.text)
                unittest.expectedFailure("test_0504_01_Add")

    # 库存管理-借料申请单-单据复制到功能
    def test_0504_02_goto(self):
        """库存管理-借料申请单-单据复制到功能"""
        driver = self.driver
        driver.find_element_by_id("BtnAdd").click()
        time.sleep(3)
        ...
        if driver.find_element_by_id("btnCopyTo").is_displayed():
            ...
            for i in v_tip:
                if "成功" in i.text:
                    ...
                    driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0504_02_goto.jpg")
                    print(i.text)
                    unittest.expectedFailure("test_0504_02_goto")
        else:
...
if __name__ == "__main__":
    ...
    testsuit.addTest(CirculateApply("test_0504_01_Add"))
