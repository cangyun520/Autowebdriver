    ...
    def test_0502_01(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0502_01.jpg")
                print(i.text)
                unittest.expectedFailure("test_0502_01")

    # 库存管理-库存转储申请-单据复制到功能
    def test_0502_02_goto(self):
        """库存管理-库存转储申请-单据复制到功能"""
        driver = self.driver
        ...
        try:
            ...
            for i in v_tip:
                if "成功" in i.text:
                    ...
                    driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_0502_02_goto.jpg")
                    print(i.text)
                    unittest.expectedFailure("test_0502_02_goto")
        except ImportError:
...
if __name__ == "__main__":
    ...
    testsuit.addTest(DumpApply("test_0502_01"))
