...
class OtherOut(unittest.TestCase):
    def setUp(self):
    ...
    def test_2206_01_Add(self):
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/test_2206_01_Add.jpg")
                print(i.text)
                unittest.expectedFailure("test_2206_01_Add")
