...
class MaterialMaster(unittest.TestCase):
    ...
    def test_2201_01_add(self):
        ...
        # 宽度
        driver.find_element_by_id("txtWidth").send_keys(random.randint(111, 999))
        # 高度
        driver.find_element_by_id("txtHeight").send_keys(random.randint(111, 999))
        # 体积
        driver.find_element_by_id("txtBulk").send_keys(random.randint(111, 999))
        # 重量
        driver.find_element_by_id("txtbulks").send_keys(random.randint(111, 999))
        # 长度
        driver.find_element_by_id("txtLength").send_keys(random.randint(111, 999))
        # 备注页签
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_2201_01_add.jpg")
                print(i.text)
                unittest.expectedFailure("test_2201_01_add")

    '''物料主数据管理-物料主数据管理-更新物料功能'''
    def test_2201_02_Update(self):
        """物料主数据管理-物料主数据管理-更新物料功能"""
        driver = self.driver
        v_tim = time.strftime("%Y%m%d%H%M%S")
        ...
        for i in v_tip:
            if "成功" in i.text:
                ...
                driver.get_screenshot_as_file(root_path() + "TestPicture/erp/test_2201_02_Update.jpg")
                print(i.text)
                unittest.expectedFailure("test_2201_02_Update")
